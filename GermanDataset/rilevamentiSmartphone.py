...
df = pd.read_csv('dataset/processed-german-dataset.csv')
...
encoder = OneHotEncoder(drop='first', sparse_output=False)  # drop='first' per evitare la multicollinearità
...
#addestro con vari algoritmi e ne calcolo il consumo in training
